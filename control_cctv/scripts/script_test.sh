...
read -p "set desired payload to 6, 0, 0.0"
rostopic pub -1 /dragonfly11/control_cctv/payload_cmd geometry_msgs/Pose '{position: {x: 6.0, y: 0.0, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}'

read -p "Press enter to switch controller"
rostopic pub -1 /$ROBOT/control_cctv/use_cctv_controller std_msgs/Bool 0

read -p "go to 5 0 1.5"
rosservice call /$ROBOT/mav_services/goTo "goal: [5.0, 0.0, 0.1, 0.0]"
